...
public class OpacityTest {
    ...
    public void opacityTest1() throws Exception {
        ...
        List urls = Arrays.asList(new CombineImageUrl[] {
            new CombineStaticImageUrl(c.getResource(pkg + "0 achtergrond.png"), null),
            new CombineStaticImageUrl(c.getResource(pkg + "1 overlay transparent.png"), null)
        });
    ...
    public void opacityTest2() throws Exception {
        ...
        List urls = Arrays.asList(new CombineImageUrl[] {
            new CombineStaticImageUrl(c.getResource(pkg + "0 achtergrond.png"), null),
            new CombineStaticImageUrl(c.getResource(pkg + "1 overlay niet transparent.png"), 0.5f)
        });
        settings.setUrls(urls);
    ...
    public void opacityTest3() throws Exception {
        ...
        List urls = Arrays.asList(new CombineImageUrl[] {
            new CombineStaticImageUrl(c.getResource(pkg + "0 topografie.png"), null),
            new CombineStaticImageUrl(c.getResource(pkg + "1 services.png"), 0.5f)
        });
        settings.setUrls(urls);
